CREATE DATABASE  IF NOT EXISTS `deseonocturno` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `deseonocturno`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: deseonocturno
-- ------------------------------------------------------
...
-- Dump completed on 2014-08-12 20:51:08
